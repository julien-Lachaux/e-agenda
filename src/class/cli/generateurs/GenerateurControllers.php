...
class GenerateurControllers extends Generateur
{
    ...
    private function genererMethodeCreer($config) {
        ...
        $methodeCreer .= $this->ajouterLignePhp("}", 1);
    ...
    private function genererMethodeAfficher($config) {
        ...
        $methodeAfficher .= $this->ajouterLignePhp("}", 1);
    ...
    private function genererMethodeLister($config) {
        ...
        $methodeLister .= $this->ajouterLignePhp("\$this->render(\"{$cheminVueTableVide}\", \${$nomVariable});", 2);
        $methodeLister .= $this->ajouterLignePhp("} else {", 2);
        $methodeLister .= $this->ajouterLignePhp("\$this->render(\"{$cheminVue}\", \${$nomVariable});", 3);
